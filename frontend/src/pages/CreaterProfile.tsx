...
const CreaterProfile = () => {
 ...
 const {data:userData,isLoading,isError} = useCreaterProifleQuery({userId:location.state.userId});
 ...
 if(isError){
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#fff7f6] via-[#fdeceb]
     to-[#f9d8d6] py-10">
