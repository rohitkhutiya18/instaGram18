...
import { useFetchPostsWithOutLoginQuery, useFetchPostWithLoginQuery } from '../features/post/services/postApi'
...
const FeedSection = () => {
  ...
  return (
    <div className='left-65 space-y-3'>
      {
       token ?  loginData?.map((val:scrollFeedInterface,index:number)=>{
